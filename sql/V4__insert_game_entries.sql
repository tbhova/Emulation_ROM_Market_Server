...
INSERT INTO GAME (ID, TITLE, CONSOLE, RELEASE_DATE, DEVELOPER, PUBLISHER, GENRE, PLAYERS, PRICE, S3LINK) VALUES
    ...
    ('340b9416-25ee-11e7-93ae-92361f002671', 'Super Mario All-Stars', 'snes', TO_DATE('2016-04-01', 'YYYY-MM-DD'), '', '', '', 1, 4.99, 'Super Mario All-Stars.smc'),
    ('40e5821e-25ee-11e7-93ae-92361f002671', 'Star Fox', '', TO_DATE('2016-04-01', 'YYYY-MM-DD'), '', '', '', 1, 4.99, 'Star Fox.smc'),
